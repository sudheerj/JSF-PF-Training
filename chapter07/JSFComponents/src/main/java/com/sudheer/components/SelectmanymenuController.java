...
public class SelectmanymenuController implements Serializable{
	...
	public String getFavCoffee1InString() {
		return Arrays.toString(favCoffee1);
	}
 
	public String getFavCoffee2InString() {
		return Arrays.toString(favCoffee2);
	}
 
	public String getFavCoffee3InString() {
		return Arrays.toString(favCoffee3);
	}
